...
class WMSATrain():
    def __init__(self, args):
        ...
        # self.entropy = nn.CrossEntropyLoss(weight=torch.tensor(
        #     [4778/1167, 4778/1860, 4778/739, 4778/1012]).to(self.args.device))
        # self.entropy = nn.CrossEntropyLoss(weight=torch.tensor(
        #     [4778/1167, 4778/1149, 4778/739, 4778/711, 4778/1012]).to(self.args.device))
        self.entropy = nn.CrossEntropyLoss(weight=torch.tensor(
            [4778/1167, 4778/1149, 4778/739, 4778/711, 4778/620, 4778/392]).to(self.args.device))
